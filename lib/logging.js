...
/** @type {import('./types').ArmorLoggerLevel[]} */
 ...
 *
 * @param {string|string[]|import('./types').LogFiltersConfig} rulesJsonPath The full path to the JSON file containing
...
/**
 * @typedef {import('./types').ArmorLoggerPrefix} ArmorLoggerPrefix
 * @typedef {import('./types').ArmorLogger} ArmorLogger
 * @typedef {import('./types').ArmorLoggerLevel} ArmorLoggerLevel
 */
