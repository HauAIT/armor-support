...
> extends ILogCommands,
   ...
   */
  cliArgs: CArgs;
  // The following properties are assigned by armor */
  server?: ArmorServer;
  serverHost?: string;
  serverPort?: number;
  serverPath?: string;
...
/**
 * Represents a driver class, which is used internally by Armor.
 *
 * This is likely unusable by external consumers, but YMMV!
 */
...
/**
 * An instance method of a driver class, whose name may be referenced by {@linkcode MethodDef.command}, and serves as an Armor command.
 *
